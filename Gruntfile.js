/*!
 * FireShell Gruntfile - Modified for use with PyroCMS Themes
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      dev: {
        files: {
          '<%= project.pyrojs %>/scripts.min.js': '<%= project.js %>'
        }
      },
      options: {
        stripBanners: true,
    ...
    cssmin: {
      ...
      dist: {
        ...
        files: {
          '<%= project.pyrocss %>/css/style.min.css': [
            '<%= project.src %>/components/normalize-css/normalize.css',
            '<%= project.assets %>/css/style.prefixed.css'
          ]
        }
    ...
    bower: {
      dev: {
        dest: '<%= project.pyrojs %>/components/'
      },
      dist: {
        dest: '<%= project.pyrojs %>/components/'   
      }
